(function () {
  ...
  Game.prototype.toggleSize = function(){
    this.perMake += 50;
    if (this.perMake > 400){
      this.perMake = 50;
    }
  ...
  Game.prototype.addStone = function (x,y){
    var positions = [ [x,y-2],[x, y-1], [x,y], [x, y+1], [x, y+2],
  ...
  Game.prototype.addManyWater = function(n, x, y){
    for (var i = n; i >= 0; i--) {
      this.add(new SandGame.WaterParticle({
        game: this,
        pos: [x + this.xPosOff(n/10),y + this.xPosOff(n/10)],
  ...
  Game.prototype.makeParticle = function (x,y){
    if (this.mode === "water"){
      this.addManyWater(this.perMake, x, y)
    } else if (this.mode === "cloud"){
      this.addManyCloud(this.perMake*2, x, y)
    } else if (this.mode === "sand"){
      this.addManySand(this.perMake, x, y)
    } else if (this.mode === "dirt"){
      this.addManyDirt(this.perMake,x,y)
  ...
  Game.prototype.xPosOff = function(n){
